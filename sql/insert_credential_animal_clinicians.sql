...
-- Additional FDA List Veterinary Credentials
  (80002, 'BVScAH', 'Bachelor of Veterinary Science and Animal Husbandry', NULL, NULL, 'Bachelor degree in veterinary science with animal husbandry specialization', TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 80002
  (80003, 'CAC', 'Certified Animal Chiropractor', NULL, NULL, 'Certified chiropractor specializing in animal chiropractic care', TRUE, TRUE, TRUE, FALSE, NULL, NULL), -- 80003
  (80004, 'CVA', 'Certified Veterinary Acupuncturist', NULL, NULL, 'Certified veterinarian or practitioner specializing in veterinary acupuncture', TRUE, TRUE, TRUE, FALSE, NULL, NULL), -- 80004
  (80005, 'DACVD', 'Diplomate of the American College of Veterinary Dermatology', 'American College of Veterinary Dermatology', NULL, 'Board certification in veterinary dermatology', FALSE, TRUE, TRUE, FALSE, NULL, NULL); -- 80005
