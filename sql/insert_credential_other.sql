...
VALUES
  ...
  (50000,  'MSD',  'Master of Science in Dentistry',         NULL, NULL, 'Advanced graduate degree in dentistry beyond DDS/DMD', TRUE,  TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 50000
  (50001, 'FAGD', 'Fellow of the Academy of General Dentistry',
                                                  'Academy of General Dentistry', 'https://www.agd.org', 'Fellowship recognition for advanced general dentistry education', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50001
  (50002, 'MAGD', 'Master of the Academy of General Dentistry',
                                                  'Academy of General Dentistry', 'https://www.agd.org', 'Mastership recognition for extensive continuing education in general dentistry', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50002
  (50003, 'RDH',    'Registered Dental Hygienist',        NULL, 'https://www.adha.org', 'Licensed professional providing preventive dental care and education', TRUE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50003
  (50004, 'RDHAP', 'Registered Dental Hygienist in Alternative Practice', NULL, NULL, 'Dental hygienist authorized to practice independently in certain states', TRUE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50004
  (50005, 'BDS',    'Bachelor of Dental Surgery',         NULL, NULL, 'Dental degree common in international healthcare systems', TRUE,  TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 50005
  ...
  (50010, 'RD',    'Registered Dietitian',                'Commission on Dietetic Registration', 'https://www.cdrnet.org', 'Licensed nutrition professional providing medical nutrition therapy', FALSE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50010
  (50011, 'RDN',    'Registered Dietitian Nutritionist',  'Commission on Dietetic Registration', 'https://www.cdrnet.org', 'Updated credential name for Registered Dietitian', FALSE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50011
...
VALUES
  ...
  (50018, 'RADT',   'Registered Radiologic Technologist', 'American Registry of Radiologic Technologists', 'https://www.arrt.org', 'Certified technologist performing diagnostic imaging procedures', FALSE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50018
  (50019, 'CNIM',   'Certified Neurophysiologic Intraoperative Monitoring', 'American Board of Neurophysiologic Monitoring', 'https://www.abnm.info', 'Specialist monitoring nervous system function during surgery', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50019
  (50020, 'CT',     'Computed Tomography Technologist',  'American Registry of Radiologic Technologists', 'https://www.arrt.org', 'Specialized technologist operating CT scanning equipment', FALSE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50020
  (50021, 'CCP',    'Certified Clinical Perfusionist', 'American Board of Cardiovascular Perfusion', 'https://www.abcp.org', 'Specialist operating heart-lung machines during cardiac surgery', FALSE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50021
  (50022, 'CST',    'Certified Surgical Technologist',    'National Board of Surgical Technology and Surgical Assisting', 'https://www.nbstsa.org', 'Certified technologist assisting in surgical procedures', FALSE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50022
  
  -- Vision and Hearing Specialists
  (50023, 'OPTICIAN', 'Licensed Optician',                        NULL, 'https://www.abo-ncle.org', 'Professional fitting and dispensing eyeglasses and contact lenses', TRUE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50023
  (50024, 'LDO',    'Licensed Dispensing Optician',      NULL, NULL, 'Licensed professional dispensing corrective eyewear', TRUE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50024
  (50025, 'BC-HIS', 'Board Certified Hearing Instrument Specialist', 'National Board for Certification in Hearing Instrument Sciences', 'https://www.nbc-his.org', 'Board certified specialist fitting and dispensing hearing aids', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50025
  
  -- Specialized Clinical Services
  (50026, 'IBCLC', 'International Board Certified Lactation Consultant', 'International Board of Lactation Consultant Examiners', 'https://iblce.org', 'Board certified specialist in breastfeeding and lactation support', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50026
  (50027, 'IDC',   'Infection Disease Control Specialist', NULL, NULL, 'Specialist in preventing and controlling infectious diseases', TRUE, TRUE,  FALSE,  FALSE, FALSE, NULL, NULL), -- 50027
...
VALUES
  ...
  (50029, 'DOULA',  'Birth Doula',                       NULL, NULL, 'Non-medical support person assisting during childbirth and postpartum', TRUE,  TRUE,  FALSE,  FALSE, FALSE, NULL, NULL), -- 50029
  (50030, 'CPM',    'Certified Professional Midwife',    'North American Registry of Midwives', 'https://narm.org', 'Certified midwife providing care during pregnancy, birth, and postpartum', FALSE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50030
  (50031, 'CD-DONA', 'Certified Doula - DONA International', 'DONA International', 'https://www.dona.org', 'DONA certified doula providing birth and postpartum support', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50031
  
  -- Rehabilitation and Assistive Device Specialists
  (50032, 'CPO',    'Certified Prosthetist Orthotist',   'American Board for Certification in Orthotics, Prosthetics and Pedorthics', 'https://www.abcop.org', 'Certified professional designing and fitting prosthetic and orthotic devices', FALSE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50032
  
  -- Health Coaching and Wellness
  (50033, 'NBC-HWC', 'National Board Certified Health and Wellness Coach', 'National Board for Health and Wellness Coaching', 'https://nbhwc.org', 'Board certified coach helping clients achieve health and wellness goals', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50033
  
  -- Communication Disorders and Advanced Practice
  (50034, 'MCD',    'Master of Communication Disorders',  NULL, NULL, 'Graduate degree in communication sciences and disorders', TRUE,  TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 50034
  (50035, 'AP',     'Advanced Practitioner',              NULL, NULL, 'General designation for advanced level healthcare practitioner', TRUE,  TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 50035
  
  -- Advanced Clinical Education Credentials
  (50036, 'CDPT',   'Clinical Doctor of Physical Therapy', NULL, NULL, 'Advanced clinical doctorate in physical therapy', TRUE, TRUE,  FALSE,  FALSE, FALSE, NULL, NULL), -- 50036
  (50037, 'BMS',    'Bachelor of Medical Science',        NULL, NULL, 'Undergraduate degree in medical sciences', TRUE,  TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 50037
  
  -- Genetic and Specialized Counseling
  (50038, 'CGC',    'Certified Genetic Counselor',        'American Board of Genetic Counseling', 'https://www.abgc.net', 'Board certified counselor providing genetic risk assessment and counseling', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 50038

-- Additional Dental Credentials  
  (50039, 'RDHEF', 'Registered Dental Hygienist Extended Function', NULL, NULL, 'Dental hygienist with expanded scope of practice beyond standard RDH', TRUE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50039
  (50040, 'RDA', 'Registered Dental Assistant', NULL, NULL, 'Certified dental assistant with advanced clinical skills', TRUE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50040
  (50041, 'ORTHODONTIST', 'Orthodontist', 'American Board of Orthodontics', 'https://www.americanboardortho.com', 'Dental specialist in tooth and jaw alignment correction', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50041
  (50042, 'ENDODONTIST', 'Endodontist', 'American Board of Endodontics', 'https://www.aae.org', 'Dental specialist in root canal therapy and pulp diseases', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50042
  (50043, 'PERIODONTIST', 'Periodontist', 'American Board of Periodontology', 'https://www.perio.org', 'Dental specialist in gum diseases and supporting structures', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50043
  (50044, 'PROSTHODONTIST', 'Prosthodontist', 'American Board of Prosthodontics', 'https://www.prosthodontics.org', 'Dental specialist in prosthetic and restorative dentistry', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50044
  (50045, 'OMFS', 'Oral and Maxillofacial Surgeon', 'American Board of Oral and Maxillofacial Surgery', 'https://www.aboms.org', 'Dental specialist in surgical treatment of face, mouth, and jaw', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50045

-- Additional Pharmacy Credentials
  (50046, 'BCPS', 'Board Certified Pharmacotherapy Specialist', 'Board of Pharmaceutical Specialties', 'https://www.bpsweb.org', 'Board certified pharmacist specializing in pharmacotherapy', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50046
  (50047, 'BCPP', 'Board Certified Psychiatric Pharmacist', 'Board of Pharmaceutical Specialties', 'https://www.bpsweb.org', 'Board certified pharmacist specializing in psychiatric medications', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50047

-- Additional Diagnostic Imaging Credentials
  (50048, 'RDMS', 'Registered Diagnostic Medical Sonographer', 'American Registry for Diagnostic Medical Sonography', 'https://www.ardms.org', 'Registered sonographer performing diagnostic ultrasound examinations', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50048
  (50049, 'RDCS', 'Registered Diagnostic Cardiac Sonographer', 'American Registry for Diagnostic Medical Sonography', 'https://www.ardms.org', 'Registered sonographer specializing in cardiac ultrasound examinations', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50049

-- Additional Nutrition Credentials
  (50050, 'DTR', 'Dietetic Technician, Registered', 'Commission on Dietetic Registration', 'https://www.cdrnet.org', 'Registered technician supporting dietitians in nutrition care', FALSE, TRUE, TRUE, FALSE, FALSE, NULL, NULL), -- 50050

-- Medical Coding and Administrative Credentials
  (50051, 'CPC', 'Certified Professional Coder', 'American Academy of Professional Coders', 'https://www.aapc.com', 'Certified professional specializing in medical coding for healthcare billing', FALSE, FALSE, TRUE, FALSE, FALSE, NULL, NULL), -- 50051

-- Additional FDA List Nutrition Credentials
  (50052, 'LN', 'Licensed Nutritionist', NULL, NULL, 'Licensed professional providing nutrition counseling and dietary guidance', TRUE, TRUE, FALSE, FALSE, FALSE, NULL, NULL), -- 50052
  (50053, 'LNC', 'Licensed Nutritionist Counselor', NULL, NULL, 'Licensed nutritionist with counseling credentials for dietary and nutrition therapy', TRUE, TRUE, FALSE, FALSE, FALSE, NULL, NULL), -- 50053
