...
VALUES
  ...
  (5000, 'CRNA', 'Certified Registered Nurse Anesthetist', 'National Board of Certification and Recertification for Nurse Anesthetists', 'https://www.nbcrna.com', 'Advanced practice registered nurse specializing in anesthesia care, providing anesthesia services in various healthcare settings', FALSE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5000
  ...
  (5007, 'ARNP',  'Advanced Registered Nurse Practitioner', NULL, NULL, 'Advanced practice registered nurse with graduate education and expanded scope of practice', TRUE,  TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 5007
  (5008, 'CRNP',  'Certified Registered Nurse Practitioner', NULL, NULL, 'Certified registered nurse with advanced education and training to provide comprehensive healthcare services', TRUE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5008
  ...
  (5014, 'PMHNP',  'Psychiatric Mental Health Nurse Practitioner', NULL, NULL, 'Advanced practice registered nurse specializing in mental health care, diagnosis and treatment of psychiatric disorders', TRUE,  TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 5014
  (5015, 'PMHNP-BC', 'Psychiatric Mental Health Nurse Practitioner Board Certified', 'American Nurses Credentialing Center', 'https://www.nursingworld.org/ancc', 'Board certified psychiatric mental health nurse practitioner providing comprehensive mental health services', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5015
...
VALUES
  ...
  (5022, 'AGACNP-BC', 'Adult-Gerontology Acute Care Nurse Practitioner Board Certified', 'American Nurses Credentialing Center', 'https://www.nursingworld.org/ancc', 'Board certified nurse practitioner specializing in acute care for adults and older adults', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5022
  -- Registered Physician Assistant variants
  (5023, 'RPA-C', 'Registered Physician Assistant Certified', NULL, NULL, 'Registered and certified physician assistant licensed to practice medicine under physician supervision', TRUE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5023
  -- Acute Care Nurse Practitioners
  (5024, 'ACNP',  'Acute Care Nurse Practitioner',      NULL, NULL, 'Nurse practitioner specializing in acute and critical care across various healthcare settings', TRUE,  TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 5024
  -- Neonatal Nurse Practitioners
  (5025, 'NNP',   'Neonatal Nurse Practitioner',        NULL, NULL, 'Nurse practitioner specializing in the care of newborns, especially high-risk and critically ill neonates', TRUE,  TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 5025
  ...
  (5034, 'PA-S',   'Physician Assistant Student',       NULL, NULL, 'Student enrolled in an accredited physician assistant educational program', TRUE, TRUE,  FALSE, FALSE, FALSE, NULL, NULL), -- 5034
  -- Neonatal Nurse Practitioner Board Certified
  (5035, 'NNP-BC', 'Neonatal Nurse Practitioner Board Certified', 'National Certification Corporation', 'https://www.nccwebsite.org', 'Board certified nurse practitioner specializing in neonatal care and high-risk newborn management', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5035
  -- Adult Nurse Practitioner Board Certified
  (5036, 'ANP-BC', 'Adult Nurse Practitioner Board Certified', 'American Nurses Credentialing Center', 'https://www.nursingworld.org/ancc', 'Board certified nurse practitioner specializing in adult healthcare across the adult lifespan', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5036
  -- Acute Care Nurse Practitioner Board Certified
  (5037, 'ACNP-BC', 'Acute Care Nurse Practitioner Board Certified', 'American Nurses Credentialing Center', 'https://www.nursingworld.org/ancc', 'Board certified nurse practitioner specializing in acute and critical care management', FALSE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5037
...
VALUES
  ...
  -- Adult Gerontology Acute Care Nurse Practitioner
  (5043, 'AG-ACNP', 'Adult Gerontology - Acute Care Nurse Practitioner', NULL, NULL, 'Nurse practitioner specializing in acute care management for adult and geriatric patients in hospital settings', TRUE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5043
  -- Advanced Registered Nurse Practitioner Certified
  (5044, 'ARNP-C', 'Advanced Registered Nurse Practitioner Certified', NULL, NULL, 'Advanced registered nurse practitioner with national certification and expanded scope of practice', TRUE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5044
  -- Adult Nurse Practitioner Certified
  (5045, 'ANP-C',  'Adult Nurse Practitioner Certified', NULL, NULL, 'Certified nurse practitioner specializing in comprehensive healthcare for adult patients', TRUE, TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5045
  -- Registered Physician Assistant
  (5046, 'RPA',    'Registered Physician Assistant',     NULL, NULL, 'Registered physician assistant licensed to practice medicine under physician supervision with expanded clinical privileges', TRUE,  TRUE,  TRUE,  FALSE, FALSE, NULL, NULL), -- 5046
